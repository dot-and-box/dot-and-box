...
export class Keywords {
    private static KEYWORDS_MAP = new Map<string, TokenType>([
        ...
        [TokenType.TEXT_COLOR.toString(), TokenType.TEXT_COLOR],
        [TokenType.BORDER_COLOR.toString(), TokenType.BORDER_COLOR],
        [TokenType.ALIGN.toString(), TokenType.ALIGN],
        [TokenType.VERTICAL_ALIGN.toString(), TokenType.VERTICAL_ALIGN],
        ...
        [TokenType.CONDITION.toString(), TokenType.CONDITION],
